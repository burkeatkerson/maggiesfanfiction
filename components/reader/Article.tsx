...
import { Reveal, RevealImage, RevealText } from "@/components/ui/motion";
      ...
      <article className="block-inner">
        <header>
          <RevealText
            ...
            className="m-0 mb-[26px] block font-display text-[clamp(34px,5.2vw,44px)] font-medium leading-[1.16] tracking-[-0.015em] text-ink"
          />
        ...
        <RevealImage className="my-[44px] mb-14">
